...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(blade.servicebuilder.svc.util.ServiceProps.get(
				"value.object.entity.cache.enabled.blade.servicebuilder.model.Foo"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(blade.servicebuilder.svc.util.ServiceProps.get(
				"value.object.finder.cache.enabled.blade.servicebuilder.model.Foo"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(blade.servicebuilder.svc.util.ServiceProps.get(
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(blade.servicebuilder.svc.util.ServiceProps.get(
