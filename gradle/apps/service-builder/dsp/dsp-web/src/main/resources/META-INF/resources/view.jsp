...
<liferay-ui:search-container delta="20" emptyResultsMessage="No data!">
	<liferay-ui:search-container-results results="<%= UseDSP.getCountries() %>" />

	<liferay-ui:search-container-row className="com.liferay.blade.samples.dspservicebuilder.model.Country" keyProperty="id" modelVar="country">
