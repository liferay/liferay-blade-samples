...
package com.liferay.blade.samples.npm.deduplication.portlets.test;
...
public class BladeNpmDeduplicationPortletsTest {

	@Deployment
	public static JavaArchive create() throws Exception {
		final File jarFile = new File(
			System.getProperty("angularConsumerPortletJarFile"));

		final File angularProviderJar = new File(
			System.getProperty("angularProviderJarFile"));

		new JMXBundleDeployer().deploy(_angularProviderJarBSN, angularProviderJar);

		return ShrinkWrap.createFromZipFile(JavaArchive.class, jarFile);
	}

	@Test
	public void testBladeAngularConsumerPortletNpm()
	...
	private static String _angularProviderJarBSN =
		"com.liferay.blade.angular.provider";
	...
	@PortalURL("com_liferay_blade_angular_consumer_portlet_AngularPortlet")
